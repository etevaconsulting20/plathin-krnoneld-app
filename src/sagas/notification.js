...
import {NOTIFICATION,SEEN_NOTIFICATION ,DELETE_NOTIFICATION}from '../actions/types';
...
getDeleteNotificationSuccess,getDeleteNotificationFailure
} from '../actions/index';
...
console.log("delete Notify",response);
