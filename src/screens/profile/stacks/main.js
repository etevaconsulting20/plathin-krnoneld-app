...
class ProfileMainScreen extends Component {
  goToLanguages = () => {
    this.props.navigation.navigate('profile-language');
  };
  render() {
    return (
      <>
        <Container>
          <ScrollView>
            ...
            <Card style={styles.AboutUsCard}>
              <View collapsable={false} style={styles.cardHeader}>
                ...
                <Right style={{padding: 16}}>
                  <View>
                    <TouchableOpacity onPress={this.goToLanguages}>
                      <Text style={_styles.mActionText}>
                        {I18n.t('profile-edit')}
                      </Text>
                    </TouchableOpacity>
                  </View>
                ...
                <Left style={{flex: 1.75}}>
                  <View>
                    <Badge style={{backgroundColor: appConfig.infoColor}} info>
                      <Text style={{...styles.CandidateName, fontSize: 14}}>
                        {getLanguageFromCode(this.props.locale)}
                      </Text>
                    </Badge>
                  </View>
                </Left>
